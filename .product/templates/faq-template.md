...
<!--
  This document contains all FAQs for the project, organized by release.
  The FIRST section is always for the NEXT upcoming release currently under development.
  Below it are FAQs from all previous releases, most recent first.

  FAQs serve two audiences:
  1. External FAQs — Questions customers would ask. Written in plain language.
  2. Internal FAQs — Questions stakeholders, engineers, or leadership would ask.
     These can be more technical and address feasibility, trade-offs, and strategy.

  Each FAQ section should challenge the press release claims and surface hard questions.
-->
...
<!--
  Add completed release FAQs below, most recent first.
  Change *(upcoming)* to the actual release date.
  Keep all historical FAQs — they document the reasoning behind past decisions.

  Example:

  ## v1.0 — Initial Launch — 2025-01-15
